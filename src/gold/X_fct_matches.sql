...
(SELECT
    ...
    CAST(MAX(CASE WHEN team_type = 'home' THEN current_score END) AS INT) homeTeam_score,
    CAST(MAX(CASE WHEN team_type = 'away' THEN current_score END) AS INT) awayTeam_score,
